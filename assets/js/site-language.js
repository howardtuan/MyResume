  ...
  const home = {
    en: {
      ...
      projects: [
        ...
        ["OpenLabFlow", "Django / LightRAG / Ollama / Docker / PostgreSQL"],
        ["Anything-to-Journal", "Codex Agent Skill / LaTeX / Evidence Traceability / Overleaf"],
      ...
      projectChips: ["Master's Thesis", "Research Platform", "Agent Skill", "Product", "Healthcare", "EdTech", "Capstone", "RAG"],
      projectLinkLabels: [[], ["GitHub / README"], ["GitHub / README", "Official Website"], ["Live Site"], ["GitHub / README"], ["Live Site"], ["GitHub / README"], ["LightRAG Repo", "LlamaIndex Repo"]],
      ...
      projectDetails: [
        ...
        ["README Summary", "OpenLabFlow is a self-hosted, open-source research knowledge and analysis workspace that combines RAG chat, source-PDF preview, document ingestion, dataset analysis, and a literature inbox.", ["Provides multiple LightRAG retrieval modes with local Ollama models and traceable source-PDF previews.", "Analyzes Excel, CSV, TSV, and JSON files by running model-planned code in an isolated, no-network container.", "Uses Docker Compose to orchestrate Django, PostgreSQL, LightRAG, background jobs, and the analysis service."]],
        ["README Summary", "Anything-to-Journal turns mixed research materials into an evidence-traceable journal or conference manuscript, editable LaTeX, an inspected PDF, and an Overleaf upload bundle.", ["Accepts PDFs, Word files, notes, spreadsheets, datasets, figures, references, and official venue templates.", "Assigns every source a stable ID and SHA-256 record, then maps used evidence back to the manuscript.", "Produces a complete, auditable, and editable submission project for either a generic format or a specific venue."]],
    ...
    zh: {
      ...
      projectChips: ["碩士論文", "研究平台", "Agent Skill", "產品", "醫療科技", "教育科技", "畢業專題", "RAG"],
      projectLinkLabels: [[], ["GitHub / README"], ["GitHub / README", "官方網站"], ["線上體驗"], ["GitHub / README"], ["線上體驗"], ["GitHub / README"], ["LightRAG 程式庫", "LlamaIndex 程式庫"]],
      thesisButton: "論文全文",
      projectDetails: [
        ...
        ["README 摘要", "OpenLabFlow 是自架式開源研究知識與分析工作區，整合 RAG 對話、來源 PDF 預覽、文件匯入、資料分析與文獻收件匣。", ["以 LightRAG 與本地 Ollama 模型提供多種檢索模式，回答後可回溯來源 PDF。", "支援 Excel、CSV、TSV 與 JSON，於無網路的隔離容器執行模型規劃的分析程式。", "使用 Docker Compose 整合 Django、PostgreSQL、LightRAG、背景工作與分析服務。"]],
        ["README 摘要", "Anything-to-Journal 將研究資料夾中的混合素材轉成證據可追溯的期刊或研討會論文、可編輯 LaTeX、檢查後 PDF 與 Overleaf 上傳包。", ["支援 PDF、Word、筆記、試算表、資料集、圖表、參考文獻與官方投稿模板。", "為每份來源建立穩定 ID 與 SHA-256 紀錄，並將使用證據對應回論文內容。", "可依通用格式或指定投稿場域產出完整、可稽核且可繼續編輯的投稿專案。"]],
